      ...
      <div className="about-content">
        ...
        <div className="about-text-block">
          ...
          <p className="about-intro">
            ...
            <br /><br />
            With experience in product management, data science, and web development, I approach problems from an interdisciplinary lens — combining data and technical skills with an understanding of people. I’ve worked on projects from social impact initiatives to AI-powered tools to teaching web development, and I’m always excited to dive headfirst into work that lets me bridge disciplines, translating ideas between designers, engineers, and researchers all while keeping users front and center.
            <br /><br />
            When I’m not glued to my laptop, you’ll probably find me giving my friends at-home (and slightly uneven) haircuts, experimenting with new recipes, or picking up a new hobby I absolutely don’t have time for. 
            <br /><br />
